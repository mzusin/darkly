...
// src/main/ui/menus/icons-menu/VIconsMenu.tsx
import React from "react";
var VIconsMenu = (props) => {
...
// src/main/ui/boxes/StretchBox.tsx
import React3 from "react";
var StretchBox = (props) => {
  const { children, classes } = props;
  return /* @__PURE__ */ React3.createElement("section", { className: `bg-slate-900 flex-1 h-full ${classes || ""}` }, children);
};

// src/main/ui/bars/BottomBar.tsx
import React4 from "react";
var BottomBar = (props) => {
  const { children, classes } = props;
  return /* @__PURE__ */ React4.createElement("section", { className: `flex items-center px-6 py-3 bg-slate-800 xl:border-l border-l-black ${classes || ""}` }, children);
};

// src/main/ui/panels/PanelTitle.tsx
import React5 from "react";
var PanelTitle = (props) => {
  const { classes, children } = props;
  return /* @__PURE__ */ React5.createElement("section", { className: `relative w-full text-center px-6 py-3 ${classes}` }, children);
};

// src/main/ui/dividers/HSplitter.tsx
import React6 from "react";
var HSplitter = (props) => {
  const { classes } = props;
  return /* @__PURE__ */ React6.createElement("section", { className: `w-full h-1.5 ${classes || ""}` }, /* @__PURE__ */ React6.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", width: "100%", height: "100%" }, /* @__PURE__ */ React6.createElement("defs", null, /* @__PURE__ */ React6.createElement("pattern", { id: "svg-stripes-pattern-8711", width: "100%", height: "3", x: "0", y: "0", patternTransform: "rotate(45)", patternUnits: "userSpaceOnUse" }, /* @__PURE__ */ React6.createElement("rect", { width: "100%", height: "1", fill: "#475669" }), /* @__PURE__ */ React6.createElement("rect", { width: "100%", height: "2", y: "4", fill: "rgba(0, 0, 0, 0)" }))), /* @__PURE__ */ React6.createElement("rect", { width: "100%", height: "100%", fill: "url(#svg-stripes-pattern-8711)" })));
};
...
// src/main/ui/menus/icons-menu/VIconsMenuLogo.tsx
import React8 from "react";
var VIconsMenuLogo = (props) => {
...
// src/main/ui/images/FramedImage.tsx
import React9 from "react";
var FramedImage = (props) => {
  const { children, classes, width, height } = props;
  const style = {
    width,
    height
  };
  return /* @__PURE__ */ React9.createElement("section", { className: `bg-black border-4 border-slate-600 max-w-full ${classes || ""}`, style }, children);
};

// src/main/ui/buttons/Button.tsx
import React10 from "react";
var EButtonType = /* @__PURE__ */ ((EButtonType2) => {
  EButtonType2[EButtonType2["Primary"] = 1] = "Primary";
  EButtonType2[EButtonType2["OutlinePrimary"] = 2] = "OutlinePrimary";
  EButtonType2[EButtonType2["Secondary"] = 3] = "Secondary";
  EButtonType2[EButtonType2["OutlineSecondary"] = 4] = "OutlineSecondary";
  return EButtonType2;
})(EButtonType || {});
var getButtonClasses = (type) => {
  const btn = `cursor-pointer mx-2 rounded-full px-8 py-1.5 transition-colors flex items-center justify-center`;
  switch (type) {
    case 2 /* OutlinePrimary */: {
      return `${btn} border-2 border-sky-800 hover:bg-sky-800`;
    }
    case 3 /* Secondary */: {
      return `${btn} bg-slate-600 hover:bg-slate-500`;
    }
    case 4 /* OutlineSecondary */: {
...
var Button = (props) => {
  ...
  return /* @__PURE__ */ React10.createElement("button", { type: "button", className: `${getButtonClasses(type)} ${classes || ""}` }, children);
};
...
var SideBar = (props) => {
  const { children, classes } = props;
  return /* @__PURE__ */ React11.createElement("section", { className: `w-40 max-w-full h-screen bg-black hidden xl:block border-l border-slate-800 ${classes || ""}` }, children);
};

// src/main/ui/bars/TopBar.tsx
import React12 from "react";
var TopBar = (props) => {
  const { children, classes } = props;
  return /* @__PURE__ */ React12.createElement("section", { className: `flex items-center px-6 py-3 bg-slate-900 ${classes || ""}` }, children);
};

// src/main/ui/form/NumberTextBox.tsx
import React13 from "react";

// node_modules/mz-react-input-number/dist/mz-react-input-number.esm.js
import { useState as Z, useEffect as _, useRef as K } from "react";
...
var D = (t, r, a) => r in t ? k(t, r, { enumerable: true, configurable: true, writable: true, value: a }) : t[r] = a;
var b = (t, r) => {
  for (var a in r || (r = {}))
    F.call(r, a) && D(t, a, r[a]);
  if (T)
    for (var a of T(r))
      O.call(r, a) && D(t, a, r[a]);
  return t;
};
var y = (t, r) => V(t, W(r));
var Q = Math.pow;
...
var P = (t) => !isNaN(parseFloat(t)) && isFinite(t);
var $ = (t, r) => {
  var a;
  if (t == null)
    return r;
  let m = (a = Number(t)) != null ? a : r;
  return isNaN(m) ? r : m;
};
var o = (t) => {
  if (!t)
...
var G = 4;
var fe = (t) => {
  let { min: r, max: a, step: m, value: v, onChangeCallback: M, onKeyDownCallback: d, decimalPlaces: C, removeRegex: c, inputClasses: A, inputStyles: I } = t, w = () => {
    let e = o(r);
    ...
    let n = (e == null ? void 0 : e.toString()) || "";
    c && (n = n.replace(c, ""));
    let l = o(n), X = Math.min(Math.max(w(), l), x());
    return isNaN(l) ? "" : h(X, f()).toString();
  }, B = () => {
    var e;
    (e = i.current) == null || e.setSelectionRange(0, 0);
  }, p = () => {
    var n, l;
    let e = ((n = i.current) == null ? void 0 : n.value) || "";
    (l = i.current) == null || l.setSelectionRange(e.length, e.length);
  }, R = () => {
    let e = E(1);
    s(isNaN(e) ? "" : e.toString()), p(), S(e);
  }, H = () => {
    let e = E(2);
    s(isNaN(e) ? "" : e.toString()), p(), S(e);
  }, [u, s] = Z(g(v)), i = K(null);
  _(() => {
    document.activeElement !== i.current && s(g(v));
  }, [v]);
  let S = (e) => {
    !isNaN(e) && M && typeof M == "function" && M(e);
  }, q = (e) => {
    let n = e.target.value;
    if (c && (n = n.replace(c, "")), s(n), n === u)
      return;
    let l = o(n);
    S(l);
  }, L = (e) => {
    ...
    switch (e) {
      case 0:
        return isNaN(n) ? NaN : h(Math.min(x(), n), f());
      case 1:
        return isNaN(n) ? NaN : h(Math.min(x(), n + N()), f());
      case 2:
        return isNaN(n) ? NaN : h(Math.max(w(), n - N()), f());
    }
    return n;
  };
  return U("input", y(b({}, (() => {
    let e = b({}, t);
    return delete e.inputStyles, delete e.inputClasses, delete e.decimalPlaces, delete e.removeRegex, delete e.onKeyDownCallback, delete e.onChangeCallback, e;
  })()), { type: "text", value: u, ref: i, onChange: q, onKeyDown: L, onBlur: z, className: A, style: I, onWheel: Y }));
};

// src/main/ui/form/NumberTextBox.tsx
var NumberTextBox = (props) => {
  const { children, classes, width } = props;
  const style = {
    width
  };
  return /* @__PURE__ */ React13.createElement("section", { className: `flex items-center justify-between ${classes || ""}` }, /* @__PURE__ */ React13.createElement("div", null, children), /* @__PURE__ */ React13.createElement("div", null, /* @__PURE__ */ React13.createElement(
    fe,
    {
      value: props.value,
...
// node_modules/toolcool-color-picker/dist/toolcool-color-picker.min.js
(() => {
  var Mt = Object.defineProperty;
  var kt = (o2, e, t) => e in o2 ? Mt(o2, e, { enumerable: true, configurable: true, writable: true, value: t }) : o2[e] = t;
  var h2 = (o2, e, t) => (kt(o2, typeof e != "symbol" ? e + "" : e, t), t);
  ...
  var p = "tc-hsv-changed", f = "tc-hue-changed", m = "tc-alpha-changed", D2 = "tc-button-clicked", nt = (o2) => {
    !o2 || document.dispatchEvent(new CustomEvent(D2, { detail: { cid: o2 } }));
  }, M = (o2, e) => {
    !o2 || document.dispatchEvent(new CustomEvent(m, { detail: { a: e, cid: o2 } }));
  }, b2 = (o2, e, t, i) => {
    !o2 || document.dispatchEvent(new CustomEvent(p, { detail: { h: e, s: t, v: i, cid: o2 } }));
  }, st = (o2, e) => {
    !o2 || document.dispatchEvent(new CustomEvent(f, { detail: { h: e, cid: o2 } }));
  };
  function u(o2, e) {
    St(o2) && (o2 = "100%");
    var t = Tt(o2);
    return o2 = e === 360 ? o2 : Math.min(e, Math.max(0, parseFloat(o2))), t && (o2 = parseInt(String(o2 * e), 10) / 100), Math.abs(o2 - e) < 1e-6 ? 1 : (e === 360 ? o2 = (o2 < 0 ? o2 % e + e : o2 % e) / parseFloat(String(e)) : o2 = o2 % e / parseFloat(String(e)), o2);
  }
  function k2(o2) {
    return Math.min(1, Math.max(0, o2));
  }
  function St(o2) {
    return typeof o2 == "string" && o2.indexOf(".") !== -1 && parseFloat(o2) === 1;
  }
  function Tt(o2) {
    return typeof o2 == "string" && o2.indexOf("%") !== -1;
  }
  function _2(o2) {
    return o2 = parseFloat(o2), (isNaN(o2) || o2 < 0 || o2 > 1) && (o2 = 1), o2;
  }
  function L(o2) {
    return o2 <= 1 ? "".concat(Number(o2) * 100, "%") : o2;
  }
  function C(o2) {
    return o2.length === 1 ? "0" + o2 : String(o2);
  }
  function at(o2, e, t) {
    return { r: u(o2, 255) * 255, g: u(e, 255) * 255, b: u(t, 255) * 255 };
  }
  function U2(o2, e, t) {
    o2 = u(o2, 255), e = u(e, 255), t = u(t, 255);
    var i = Math.max(o2, e, t), r = Math.min(o2, e, t), n = 0, s = 0, a = (i + r) / 2;
    if (i === r)
      s = 0, n = 0;
    else {
      var d = i - r;
  ...
  function O2(o2, e, t) {
    return t < 0 && (t += 1), t > 1 && (t -= 1), t < 1 / 6 ? o2 + (e - o2) * (6 * t) : t < 1 / 2 ? e : t < 2 / 3 ? o2 + (e - o2) * (2 / 3 - t) * 6 : o2;
  }
  function ht(o2, e, t) {
    var i, r, n;
    if (o2 = u(o2, 360), e = u(e, 100), t = u(t, 100), e === 0)
      r = t, n = t, i = t;
    else {
      var s = t < 0.5 ? t * (1 + e) : t + e - t * e, a = 2 * t - s;
      i = O2(a, s, o2 + 1 / 3), r = O2(a, s, o2), n = O2(a, s, o2 - 1 / 3);
    }
    return { r: i * 255, g: r * 255, b: n * 255 };
  }
  function N(o2, e, t) {
    o2 = u(o2, 255), e = u(e, 255), t = u(t, 255);
    var i = Math.max(o2, e, t), r = Math.min(o2, e, t), n = 0, s = i, a = i - r, d = i === 0 ? 0 : a / i;
    if (i === r)
      n = 0;
    else {
      switch (i) {
  ...
  function lt(o2, e, t) {
    o2 = u(o2, 360) * 6, e = u(e, 100), t = u(t, 100);
    var i = Math.floor(o2), r = o2 - i, n = t * (1 - e), s = t * (1 - r * e), a = t * (1 - (1 - r) * e), d = i % 6, w = [t, s, n, n, a, t][d], x = [a, t, t, s, n, n][d], R = [n, n, a, t, t, s][d];
    return { r: w * 255, g: x * 255, b: R * 255 };
  }
  function K2(o2, e, t, i) {
    var r = [C(Math.round(o2).toString(16)), C(Math.round(e).toString(16)), C(Math.round(t).toString(16))];
  ...
  function dt(o2, e, t, i, r) {
    var n = [C(Math.round(o2).toString(16)), C(Math.round(e).toString(16)), C(Math.round(t).toString(16)), C(Rt(i))];
  ...
  function Rt(o2) {
    return Math.round(parseFloat(o2) * 255).toString(16);
  }
  function V2(o2) {
    return g(o2) / 255;
  }
  function g(o2) {
    return parseInt(o2, 16);
  }
  function ut(o2) {
    return { r: o2 >> 16, g: (o2 & 65280) >> 8, b: o2 & 255 };
  }
  ...
  function ct(o2) {
    var e = { r: 0, g: 0, b: 0 }, t = 1, i = null, r = null, n = null, s = false, a = false;
    return typeof o2 == "string" && (o2 = Pt(o2)), typeof o2 == "object" && (E(o2.r) && E(o2.g) && E(o2.b) ? (e = at(o2.r, o2.g, o2.b), s = true, a = String(o2.r).substr(-1) === "%" ? "prgb" : "rgb") : E(o2.h) && E(o2.s) && E(o2.v) ? (i = L(o2.s), r = L(o2.v), e = lt(o2.h, i, r), s = true, a = "hsv") : E(o2.h) && E(o2.s) && E(o2.l) && (i = L(o2.s), n = L(o2.l), e = ht(o2.h, i, n), s = true, a = "hsl"), Object.prototype.hasOwnProperty.call(o2, "a") && (t = o2.a)), t = _2(t), { ok: s, format: o2.format || a, r: Math.min(255, Math.max(e.r, 0)), g: Math.min(255, Math.max(e.g, 0)), b: Math.min(255, Math.max(e.b, 0)), a: t };
  }
  var Dt = "[-\\+]?\\d+%?", _t = "[-\\+]?\\d*\\.\\d+%?", y2 = "(?:".concat(_t, ")|(?:").concat(Dt, ")"), G2 = "[\\s|\\(]+(".concat(y2, ")[,|\\s]+(").concat(y2, ")[,|\\s]+(").concat(y2, ")\\s*\\)?"), F2 = "[\\s|\\(]+(".concat(y2, ")[,|\\s]+(").concat(y2, ")[,|\\s]+(").concat(y2, ")[,|\\s]+(").concat(y2, ")\\s*\\)?"), v = { CSS_UNIT: new RegExp(y2), rgb: new RegExp("rgb" + G2), rgba: new RegExp("rgba" + F2), hsl: new RegExp("hsl" + G2), hsla: new RegExp("hsla" + F2), hsv: new RegExp("hsv" + G2), hsva: new RegExp("hsva" + F2), hex3: /^#?([0-9a-fA-F]{1})([0-9a-fA-F]{1})([0-9a-fA-F]{1})$/, hex6: /^#?([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})$/, hex4: /^#?([0-9a-fA-F]{1})([0-9a-fA-F]{1})([0-9a-fA-F]{1})([0-9a-fA-F]{1})$/, hex8: /^#?([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})$/ };
  function Pt(o2) {
    if (o2 = o2.trim().toLowerCase(), o2.length === 0)
      return false;
    var e = false;
    if (A[o2])
      o2 = A[o2], e = true;
    else if (o2 === "transparent")
      return { r: 0, g: 0, b: 0, a: 0, format: "name" };
    var t = v.rgb.exec(o2);
    return t ? { r: t[1], g: t[2], b: t[3] } : (t = v.rgba.exec(o2), t ? { r: t[1], g: t[2], b: t[3], a: t[4] } : (t = v.hsl.exec(o2), t ? { h: t[1], s: t[2], l: t[3] } : (t = v.hsla.exec(o2), t ? { h: t[1], s: t[2], l: t[3], a: t[4] } : (t = v.hsv.exec(o2), t ? { h: t[1], s: t[2], v: t[3] } : (t = v.hsva.exec(o2), t ? { h: t[1], s: t[2], v: t[3], a: t[4] } : (t = v.hex8.exec(o2), t ? { r: g(t[1]), g: g(t[2]), b: g(t[3]), a: V2(t[4]), format: e ? "name" : "hex8" } : (t = v.hex6.exec(o2), t ? { r: g(t[1]), g: g(t[2]), b: g(t[3]), format: e ? "name" : "hex" } : (t = v.hex4.exec(o2), t ? { r: g(t[1] + t[1]), g: g(t[2] + t[2]), b: g(t[3] + t[3]), a: V2(t[4] + t[4]), format: e ? "name" : "hex8" } : (t = v.hex3.exec(o2), t ? { r: g(t[1] + t[1]), g: g(t[2] + t[2]), b: g(t[3] + t[3]), format: e ? "name" : "hex" } : false)))))))));
  }
  function E(o2) {
    return Boolean(v.CSS_UNIT.exec(String(o2)));
  }
  var l = function() {
    function o2(e, t) {
    ...
    return o2.prototype.isDark = function() {
      return this.getBrightness() < 128;
    }, o2.prototype.isLight = function() {
      return !this.isDark();
    }, o2.prototype.getBrightness = function() {
      var e = this.toRgb();
      return (e.r * 299 + e.g * 587 + e.b * 114) / 1e3;
    }, o2.prototype.getLuminance = function() {
      var e = this.toRgb(), t, i, r, n = e.r / 255, s = e.g / 255, a = e.b / 255;
      return n <= 0.03928 ? t = n / 12.92 : t = Math.pow((n + 0.055) / 1.055, 2.4), s <= 0.03928 ? i = s / 12.92 : i = Math.pow((s + 0.055) / 1.055, 2.4), a <= 0.03928 ? r = a / 12.92 : r = Math.pow((a + 0.055) / 1.055, 2.4), 0.2126 * t + 0.7152 * i + 0.0722 * r;
    }, o2.prototype.getAlpha = function() {
      return this.a;
    }, o2.prototype.setAlpha = function(e) {
      return this.a = _2(e), this.roundA = Math.round(100 * this.a) / 100, this;
    }, o2.prototype.toHsv = function() {
      var e = N(this.r, this.g, this.b);
      return { h: e.h * 360, s: e.s, v: e.v, a: this.a };
    }, o2.prototype.toHsvString = function() {
    ...
    }, o2.prototype.toHsl = function() {
      var e = U2(this.r, this.g, this.b);
      return { h: e.h * 360, s: e.s, l: e.l, a: this.a };
    }, o2.prototype.toHslString = function() {
      var e = U2(this.r, this.g, this.b), t = Math.round(e.h * 360), i = Math.round(e.s * 100), r = Math.round(e.l * 100);
      return this.a === 1 ? "hsl(".concat(t, ", ").concat(i, "%, ").concat(r, "%)") : "hsla(".concat(t, ", ").concat(i, "%, ").concat(r, "%, ").concat(this.roundA, ")");
    }, o2.prototype.toHex = function(e) {
      return e === void 0 && (e = false), K2(this.r, this.g, this.b, e);
    }, o2.prototype.toHexString = function(e) {
      return e === void 0 && (e = false), "#" + this.toHex(e);
    }, o2.prototype.toHex8 = function(e) {
      return e === void 0 && (e = false), dt(this.r, this.g, this.b, this.a, e);
    }, o2.prototype.toHex8String = function(e) {
      return e === void 0 && (e = false), "#" + this.toHex8(e);
    }, o2.prototype.toRgb = function() {
      return { r: Math.round(this.r), g: Math.round(this.g), b: Math.round(this.b), a: this.a };
    }, o2.prototype.toRgbString = function() {
    ...
    }, o2.prototype.toPercentageRgb = function() {
      var e = function(t) {
        return "".concat(Math.round(u(t, 255) * 100), "%");
      };
      return { r: e(this.r), g: e(this.g), b: e(this.b), a: this.a };
    }, o2.prototype.toPercentageRgbString = function() {
      var e = function(t) {
        return Math.round(u(t, 255) * 100);
      };
      return this.a === 1 ? "rgb(".concat(e(this.r), "%, ").concat(e(this.g), "%, ").concat(e(this.b), "%)") : "rgba(".concat(e(this.r), "%, ").concat(e(this.g), "%, ").concat(e(this.b), "%, ").concat(this.roundA, ")");
    }, o2.prototype.toName = function() {
      if (this.a === 0)
        return "transparent";
      if (this.a < 1)
        return false;
      for (var e = "#" + K2(this.r, this.g, this.b, false), t = 0, i = Object.entries(A); t < i.length; t++) {
        var r = i[t], n = r[0], s = r[1];
        if (e === s)
          return n;
      }
      return false;
    }, o2.prototype.toString = function(e) {
      var t = Boolean(e);
      ...
      return new o2(this.toString());
    }, o2.prototype.lighten = function(e) {
      e === void 0 && (e = 10);
      var t = this.toHsl();
      return t.l += e / 100, t.l = k2(t.l), new o2(t);
    }, o2.prototype.brighten = function(e) {
      e === void 0 && (e = 10);
      var t = this.toRgb();
      return t.r = Math.max(0, Math.min(255, t.r - Math.round(255 * -(e / 100)))), t.g = Math.max(0, Math.min(255, t.g - Math.round(255 * -(e / 100)))), t.b = Math.max(0, Math.min(255, t.b - Math.round(255 * -(e / 100)))), new o2(t);
    }, o2.prototype.darken = function(e) {
      e === void 0 && (e = 10);
      var t = this.toHsl();
      return t.l -= e / 100, t.l = k2(t.l), new o2(t);
    }, o2.prototype.tint = function(e) {
      return e === void 0 && (e = 10), this.mix("white", e);
    }, o2.prototype.shade = function(e) {
      return e === void 0 && (e = 10), this.mix("black", e);
    }, o2.prototype.desaturate = function(e) {
      e === void 0 && (e = 10);
      var t = this.toHsl();
      return t.s -= e / 100, t.s = k2(t.s), new o2(t);
    }, o2.prototype.saturate = function(e) {
      e === void 0 && (e = 10);
      var t = this.toHsl();
      return t.s += e / 100, t.s = k2(t.s), new o2(t);
    }, o2.prototype.greyscale = function() {
      return this.desaturate(100);
    }, o2.prototype.spin = function(e) {
      var t = this.toHsl(), i = (t.h + e) % 360;
      return t.h = i < 0 ? 360 + i : i, new o2(t);
    }, o2.prototype.mix = function(e, t) {
      t === void 0 && (t = 50);
      var i = this.toRgb(), r = new o2(e).toRgb(), n = t / 100, s = { r: (r.r - i.r) * n + i.r, g: (r.g - i.g) * n + i.g, b: (r.b - i.b) * n + i.b, a: (r.a - i.a) * n + i.a };
      return new o2(s);
    }, o2.prototype.analogous = function(e, t) {
      e === void 0 && (e = 6), t === void 0 && (t = 30);
      var i = this.toHsl(), r = 360 / t, n = [this];
      for (i.h = (i.h - (r * e >> 1) + 720) % 360; --e; )
        i.h = (i.h + r) % 360, n.push(new o2(i));
      return n;
    }, o2.prototype.complement = function() {
      var e = this.toHsl();
      return e.h = (e.h + 180) % 360, new o2(e);
    }, o2.prototype.monochromatic = function(e) {
      e === void 0 && (e = 6);
      for (var t = this.toHsv(), i = t.h, r = t.s, n = t.v, s = [], a = 1 / e; e--; )
        s.push(new o2({ h: i, s: r, v: n })), n = (n + a) % 1;
      return s;
    }, o2.prototype.splitcomplement = function() {
      var e = this.toHsl(), t = e.h;
      return [this, new o2({ h: (t + 72) % 360, s: e.s, l: e.l }), new o2({ h: (t + 216) % 360, s: e.s, l: e.l })];
    }, o2.prototype.onBackground = function(e) {
      var t = this.toRgb(), i = new o2(e).toRgb();
      return new o2({ r: i.r + (t.r - i.r) * t.a, g: i.g + (t.g - i.g) * t.a, b: i.b + (t.b - i.b) * t.a });
    }, o2.prototype.triad = function() {
      return this.polyad(3);
    }, o2.prototype.tetrad = function() {
      return this.polyad(4);
    }, o2.prototype.polyad = function(e) {
      for (var t = this.toHsl(), i = t.h, r = [this], n = 360 / e, s = 1; s < e; s++)
        r.push(new o2({ h: (i + s * n) % 360, s: t.s, l: t.l }));
      return r;
    }, o2.prototype.equals = function(e) {
      return this.toRgbString() === new o2(e).toRgbString();
    }, o2;
  }();
  var $2 = () => Math.random().toString(16).slice(2), P2 = (o2) => Math.round((o2 + Number.EPSILON) * 100) / 100;
  var H = 0.01, q = (o2) => (o2 < 0 && (o2 = 0), o2 > 360 && (o2 = 360), `hsl(${Math.round(o2)}, 100%, 50%)`), z = (o2) => {
    let e = o2.toRgb();
    return `linear-gradient(to right, rgba(${e.r},${e.g},${e.b}, 0) 0%, rgba(${e.r},${e.g},${e.b}, 1) 100%)`;
  }, S = (o2) => {
    let e = o2.toRgb();
    return `rgba(${e.r}, ${e.g}, ${e.b}, ${P2(e.a)})`;
  }, pt = (o2) => {
    let e = o2.toHsl();
    return `hsla(${Math.round(e.h)}, ${Math.round(e.s * 100)}%, ${Math.round(e.l * 100)}%, ${P2(e.a)})`;
  }, gt = (o2) => {
    let e = o2.toHsv();
    return `hsva(${Math.round(e.h)}, ${Math.round(e.s * 100)}%, ${Math.round(e.v * 100)}%, ${P2(e.a)})`;
  }, W2 = (o2) => (o2 < 0 && (o2 = 0), o2 > 1 && (o2 = 1), `${(-(o2 * 100) + 100).toFixed(2)}%`), X = (o2) => (o2 < 0 && (o2 = 0), o2 > 1 && (o2 = 1), `${(o2 * 100).toFixed(2)}%`), T2 = (o2) => {
    o2 < 0 && (o2 = 0), o2 > 360 && (o2 = 360);
    let e = o2 * 100 / 360, t = Math.round(e * 100) / 100;
    return t < 0 && (t = 0), t > 100 && (t = 100), t;
  }, B = (o2) => 360 * o2 / 100, I = (o2) => {
    let e = Number(o2) || 0;
  ...
  var j = class extends HTMLElement {
    constructor() {
      ...
      h2(this, "value", 0);
      this.attachShadow({ mode: "open" }), this.onMouseDown = this.onMouseDown.bind(this), this.onMouseUp = this.onMouseUp.bind(this), this.onChange = this.onChange.bind(this), this.onPointerKeyDown = this.onPointerKeyDown.bind(this), this.hsvChanged = this.hsvChanged.bind(this), this.hueChanged = this.hueChanged.bind(this);
    }
    static get observedAttributes() {
      return ["color"];
    }
    render(t = true) {
      this.$pointer && (this.$pointer.style.left = X(this.saturation), this.$pointer.style.top = W2(this.value)), this.$color && this.$color.setAttribute("style", `background: ${q(this.hue)}`), t && b2(this.cid, this.hue, this.saturation, this.value);
    }
    onChange(t) {
      if (!this.$saturation)
        return;
      ...
      if (i === 0 || r === 0)
        return;
      let a = typeof t.clientX == "number" ? t.clientX : t.touches[0].clientX, d = typeof t.clientY == "number" ? t.clientY : t.touches[0].clientY, w = Math.min(Math.max(0, a - n), i), x = Math.min(Math.max(0, d - s), r);
    ...
    connectedCallback() {
      ...
      let r = W2(this.value), n = X(this.saturation);
    ...
    attributeChangedCallback(t, i, r) {
      let s = c(r).toHsv();
      this.hue = s.h, this.saturation = s.s, this.value = s.v, this.render(false);
    }
  }, bt = j;
  ...
  var Y = class extends HTMLElement {
    constructor() {
      ...
      h2(this, "$pointer");
      h2(this, "hue", 0);
      this.attachShadow({ mode: "open" }), this.onMouseDown = this.onMouseDown.bind(this), this.onMouseUp = this.onMouseUp.bind(this), this.onChange = this.onChange.bind(this), this.onKeyDown = this.onKeyDown.bind(this), this.hsvChanged = this.hsvChanged.bind(this);
    }
    static get observedAttributes() {
      return ["color"];
    }
    render() {
      this.$pointer && (this.$pointer.style.left = `${T2(this.hue)}%`), st(this.cid, this.hue);
    }
    hsvChanged(t) {
    ...
    onChange(t) {
      ...
      if (i === 0)
        return;
      let n = typeof t.clientX == "number" ? t.clientX : t.touches[0].clientX, s = Math.min(Math.max(0, n - r), i), a = Math.min(Math.max(0, Math.round(s * 100 / i)), 100);
           ...
           <div class="hue">
                <div class="box">
                    ...
                    <div class="pointer box">
                        <div class="pointer-box" tabindex="0" style="left: ${T2(this.hue)}%">
                            <div class="handler"></div>
                        </div>
                    </div>
                </div>
  ...
  var Q2 = class extends HTMLElement {
    constructor() {
      super();
      h2(this, "cid");
      h2(this, "$alpha");
      ...
      h2(this, "saturation", 0);
      h2(this, "value", 0);
      this.attachShadow({ mode: "open" }), this.onMouseDown = this.onMouseDown.bind(this), this.onMouseUp = this.onMouseUp.bind(this), this.onChange = this.onChange.bind(this), this.onKeyDown = this.onKeyDown.bind(this), this.hsvChanged = this.hsvChanged.bind(this), this.hueChanged = this.hueChanged.bind(this), this.alphaChanged = this.alphaChanged.bind(this);
    }
    static get observedAttributes() {
      return ["color"];
    }
    ...
    onChange(t) {
      ...
      if (i === 0)
        return;
      let n = typeof t.clientX == "number" ? t.clientX : t.touches[0].clientX, s = Math.min(Math.max(0, n - r), i), a = Math.min(Math.max(0, s * 100 / i), 100);
      ...
      switch (t.key) {
        case "ArrowUp": {
          if (i === "r") {
            ...
            let a = new l(r).toHsv();
            b2(this.cid, a.h, a.s, a.v), this.$r.value = this.r.toString(), this.render();
          }
          if (i === "g") {
            this.g = Math.min(255, r.g + 1), r.g = this.g;
            let a = new l(r).toHsv();
            b2(this.cid, a.h, a.s, a.v), this.$g.value = this.g.toString(), this.render();
          }
          if (i === "b") {
            this.b = Math.min(255, r.b + 1), r.b = this.b;
            let a = new l(r).toHsv();
            b2(this.cid, a.h, a.s, a.v), this.$b.value = this.b.toString(), this.render();
          }
          if (i === "a") {
  ...
  var Z2 = class extends HTMLElement {
    constructor() {
      super();
      h2(this, "cid");
  ...
  var Ut = { sm: "0.875rem", md: "1.2rem", lg: "1.5rem", xl: "2.25rem", "2xl": "3rem", "3xl": "3.75rem", "4xl": "4.5rem" }, tt = class extends HTMLElement {
    constructor() {
      super();
      h2(this, "cid");
      h2(this, "$button");
    ...
    initState() {
      let t = this;
      this.state = new Proxy(t.stateDefaults, { set(i, r, n, s) {
    ...
    onColorChange() {
      this.$buttonColor && (this.$buttonColor.style.backgroundColor = S(this.state.color)), this.dispatchEvent(new CustomEvent("change", { detail: { hex: this.hex, hex8: this.hex8, rgb: this.rgb, rgba: this.rgba, hsl: this.hsl, hsla: this.hsla, hsv: this.hsv, hsva: this.hsva, color: this.color } }));
    }
    hsvChanged(t) {
    ...
    buttonClicked(t) {
      !t || !t.detail || !t.detail.cid || t.detail.cid !== this.cid && (this.state.isPopupVisible = false);
    }
    clickedOutside() {
    ...
    onKeyDown(t) {
      t.key === "Escape" && (this.state.isPopupVisible = false);
    }
    stopPropagation(t) {
      t.stopPropagation();
    }
...
var ColorPicker = (props) => {
  ...
  return /* @__PURE__ */ React14.createElement("section", { className: `flex items-center justify-between ${classes || ""}` }, /* @__PURE__ */ React14.createElement("div", null, children), /* @__PURE__ */ React14.createElement("div", null, /* @__PURE__ */ React14.createElement("toolcool-color-picker", { color, setColor })));
};

// src/main/ui/form/icons-radio-buttons/IconRadioButton.tsx
import React15 from "react";
var IconRadioButton = (props) => {
...
// src/main/ui/form/icons-radio-buttons/IconRadioButtonGroup.tsx
import React16 from "react";
var IconRadioButtonGroup = (props) => {
  const { children, classes } = props;
  return /* @__PURE__ */ React16.createElement("section", { className: `m-4 grid grid-cols-4 gap-2 ${classes || ""}` }, children);
};

// src/main/ui/form/buttons-group/ButtonsGroup.tsx
import React17 from "react";
var ButtonsGroup = (props) => {
  const { children, classes } = props;
  return /* @__PURE__ */ React17.createElement("section", { className: `m-4 grid grid-cols-4 gap-2 ${classes || ""}` }, children);
};

// src/main/ui/form/buttons-group/ButtonsGroupButton.tsx
import React18 from "react";
var ButtonsGroupButton = (props) => {
...
// src/main/ui/menus/mobile-menu/HamburgerButton.tsx
import React19, { useEffect } from "react";

// src/main/domain/mobile-menu-provider.ts
var MOBILE_MENU_CLASS = "darkly-show-m-menu";
var closeMobileMenu = () => {
...
var HamburgerButton = (props) => {
  ...
  return /* @__PURE__ */ React19.createElement(
    ...
    /* @__PURE__ */ React19.createElement(
      ...
      /* @__PURE__ */ React19.createElement("path", { stroke: "none", d: "M0 0h24v24H0z" }),
      /* @__PURE__ */ React19.createElement("path", { d: "M4 6h16M4 12h16M4 18h16" })
    )
  );
};

// src/main/ui/menus/mobile-menu/CloseMobileMenuButton.tsx
import React20 from "react";
var CloseMobileMenuButton = (props) => {
  const { classes } = props;
  return /* @__PURE__ */ React20.createElement(
    ...
    /* @__PURE__ */ React20.createElement(
      ...
      /* @__PURE__ */ React20.createElement("path", { stroke: "none", d: "M0 0h24v24H0z", fill: "none" }),
      /* @__PURE__ */ React20.createElement("path", { d: "M18 6l-12 12" }),
      /* @__PURE__ */ React20.createElement("path", { d: "M6 6l12 12" })
    )
  );
};
export {
